...
const Hero = () => {
    return (
        <div className='w-11/12 p-6 md:p-12'>
            ...
            <form className='flex flex-col md:flex-row p-4 space-x-4 justify-center items-center'>
                <input type="text" placeholder='Search Phone By Name' className='bg-white w-2/3 h-12 rounded-lg p-4 border border-gray-200 shadow-md' />
